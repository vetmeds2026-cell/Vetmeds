...
## Developed by Omkar M. Veershaiv-Wangi
...
│   ├── _components/         # Shared UI — Header, Footer, Hero
│   ├── api/                 # Next.js API routes
│   │   ├── appointments/    # Appointment CRUD + email notifications
│   │   ├── emergencysos/    # SOS creation, history, Cloudinary upload
│   │   ├── pet-profiles/    # Pet profile CRUD
│   │   ├── collected-points/# Kind Soul Points management
│   │   └── contact/         # Contact Us email sender
│   ├── configs/             # Drizzle DB config & schema
│   ├── dashboard/           # User-facing dashboard pages
│   │   ├── aboutus/
│   │   ├── chatbot/         # PawBot AI
│   │   ├── contactus/
│   │   ├── emergencysos/    # Emergency SOS page
│   │   ├── petAppointment/  # Booking flow
│   │   └── profile/         # Pet profile management
│   ├── doctor-dashboard/    # Doctor portal
│   ├── doctor-login/        # Doctor authentication
│   └── lib/                 # Email templates & Nodemailer
